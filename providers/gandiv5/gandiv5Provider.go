...
func (c *api) GetNameservers(domain string) ([]*Nameserver, error) {
...
func GetDomainCorrections(dc *DomainConfig) ([]*Correction, error) {

	// call GetZoneRecords()
	// call CleanZoneRecords()
	// call GenerateZoneCorrections()
