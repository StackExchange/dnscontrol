...
Use the Facade Pattern to create
a simplified interface to the SDK.

This isn't needed if the SDK offers the functions you want.
...
too fast" or "temporary error, please re-try later) erros.
