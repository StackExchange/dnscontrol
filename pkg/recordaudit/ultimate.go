...
/*
I proposed that Go add something like "len()" but returns the highest
index. This would avoid off-by-one errors.  The proposed names are
ultimate(), ulti(), last() or highest().
