...
var (
	...
	auditRecordsTestFlag = flag.Bool("auditrecords", false, "Validate AuditRecords mode: only run tests normally excluded (default is false)")
...
func getAuditRecordsMode(t *testing.T) (mode bool) {
	return *auditRecordsTestFlag
}
