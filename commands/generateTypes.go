...
var _ = cmd(catUtils, func() *cli.Command {
	...
	return &cli.Command{
		Name:  "types",
		Usage: "Configure a TypeScript declaration file in the current directory",
		Action: func(c *cli.Context) error {
			return exit(DownloadTypes(args))
		},
		Flags: args.flags(),
	}
}())
...
// DownloadTypes downloads and installs the version of the .d.ts file corresponding to this version of dnscontrol.
func DownloadTypes(args TypesArgs) error {
	...
	file.WriteString("// To update it, run `dnscontrol types`.\n\n")
